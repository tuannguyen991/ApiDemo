        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EpubLink = table.Column<string>(type: "text", nullable: true),
                    ImageLink = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppReadingPackages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBookWithCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBookWithCategories_AppBooks_BookId",
                        column: x => x.BookId,
                        principalTable: "AppBooks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppBookWithCategories_AppCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rangy = table.Column<string>(type: "text", nullable: true),
                    Uuid = table.Column<string>(type: "text", nullable: true),
                    Note = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppHighlights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppHighlights_AppBooks_BookId",
                        column: x => x.BookId,
                        principalTable: "AppBooks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppHighlights_AppUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBookWithCategories_BookId",
                table: "AppBookWithCategories",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookWithCategories_CategoryId",
                table: "AppBookWithCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppHighlights_BookId",
                table: "AppHighlights",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AppHighlights_UserId",
                table: "AppHighlights",
                column: "UserId");
